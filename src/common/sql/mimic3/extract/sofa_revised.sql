...
DROP TABLE IF EXISTS sofa_revised; CREATE TABLE sofa_revised AS 
-- ------------------------------------------------------------------
...
select ie.subject_id, ie.hadm_id, ie.icustay_id
  , meanbp_min
  , rate_dobutamine as rate_dobutamine_max
  , rate_dopamine as rate_dopamine_max
  , rate_epinephrine as rate_epinephrine_max
  , rate_norepinephrine as rate_norepinephrine_max
  , creatinine_max
  , bilirubin_max
  , platelet_min
  --, platelet_max
