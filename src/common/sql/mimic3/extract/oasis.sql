...
, case when preiculos is null then null
     ...
     -- NOTE: bug fixed here, originally is the other way around (1 and then 2)
...
select
  ...
  , icustay_expire_flag
  , oasis
  -- Calculate the probability of icustay mortality
  , 1 / (1 + exp(- (-7.4225 + 0.1434*(oasis) ))) as icu_mort_proba
  , age
  , preiculos
  , gcs
