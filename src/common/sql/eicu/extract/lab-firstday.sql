DROP TABLE IF EXISTS lab_firstday CASCADE;
CREATE TABLE lab_firstday as
-- get lab measures
with vw0 as
(
    select
  ...
  -- Ensre that measurements all occur in 1 Day (24 Hours or 1440 Minutes) from unit admit time. 
