-- PURPOSE: extract traditional risk score baseline, based on study population of APACHE IV
DROP TABLE IF EXISTS baselines; CREATE TABLE baselines AS
