...
if __name__ == "__main__":
    ...
    elif args.data == "mimic_cmo":
        args.path = f"src/exp_6.6_to_6.27/data/TRAIN-union-features-excluded-cmo.csv\nsrc/exp_6.6_to_6.27/data/TEST-union-features-excluded-cmo.csv"
        train = pd.read_csv('src/exp_6.6_to_6.27/data/TRAIN-union-features-excluded-cmo.csv')
        test = pd.read_csv('src/exp_6.6_to_6.27/data/TEST-union-features-excluded-cmo.csv')
        train = pd.concat([train, test], axis=0)
